...
internal class OauthServiceTest : DescribeSpec({
    ...
    companion object {
        ...
        const val   expectedUrlCall = "https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=testId&scope=openid&redirect_uri=http://globalpost.any/mypath&state=5DwIT0u7K/GDne5GbYUstQ==@Z0GCZibsGi2m32XO2BO3J/i7GyncfvHwADR7y2lZxm9NoVYGNZ2k7reTDuZ4GLbdE4lXZMA8bG3vHLM9ZDYo3XQZ7nXUZa+/FeO12M2ire7gYCHOLf+V/4Xl/hbetiGHT7z5FnzlrtVlG6wQZaZJBn2NdzuLZ4grQHY8jThP8nI=&login_hint=jsmith@example.com&nonce=0.6655489"
    }
}
